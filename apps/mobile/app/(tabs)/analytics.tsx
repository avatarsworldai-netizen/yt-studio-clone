  ...
  function ChartCard() {
    ...
    return (
      <View style={s.chartCard}>
        ...
        {isAdmin && <AE isAdmin={isAdmin} table="ui_analytics" column="chart_pattern" rowId="chart_main" label={`Patrón gráfica (1-40): ${patternName}`} value={chartPattern}>
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {isAdmin && <AE isAdmin={isAdmin} table="ui_analytics" column="chart_pattern" rowId="feed_chart" label={`Patrón gráfica feed (1-40): ${feedPatternName}`} value={feedPattern}>
            ...
            return (
              <View key={idx} style={s.vgChartOuter}>
                <View style={s.vgChartCardFixed}>
                  ...
                  {isAdmin && <AE isAdmin={isAdmin} table="ui_analytics" column="chart_pattern" rowId={`cv_chart_${idx}`} label={`Patrón gráfica contenido ${idx+1} (1-40): ${cvPatternName}`} value={cvPattern}>
            ...
            return (
              <View key={idx} style={s.vgChartOuter}>
                <View style={s.vgChartCardFixed}>
                  ...
                  {isAdmin && <AE isAdmin={isAdmin} table="ui_analytics" column="chart_pattern" rowId={`vg_chart_${idx}`} label={`Patrón gráfica VG ${idx+1} (1-40): ${vgPatternName}`} value={vgPattern}>
    ...
    return (
      <View style={{ marginHorizontal: 16 }}>
        {isAdmin && <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 4 }}>
          <AE isAdmin={isAdmin} table="ui_analytics" column="bar_pattern" rowId={`ie_${periodKey}`} label={`Patrón barras ${periodKey} (1-40): ${currentBarPatternName}`} value={currentBarPatternId}>
      ...
      <ScrollView style={s.root} showsVerticalScrollIndicator={false}>
        ...
        {(() => {
          ...
          function PatternSelector() {
            ...
            return (
              <AE isAdmin={isAdmin} table="ui_analytics" column="chart_pattern" rowId={`ie_${periodKey}`} label={`Patrón gráfica ${periodKey} (1-40): ${iePatternName}`} value={iePattern}>
