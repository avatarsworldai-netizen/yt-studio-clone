...
const s = StyleSheet.create({
  ...
  hero: { backgroundColor: C.cardBg, borderRadius: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 6, elevation: 2, marginHorizontal: 16, marginTop: 12, padding: 20 },
  ...
  miniCard: { flex: 1, backgroundColor: C.cardBg, borderRadius: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 6, elevation: 2, padding: 14 },
  miniLbl: { fontSize: F.s12, color: C.textSec },
  miniVal: { fontSize: F.s18, fontWeight: '700', color: C.text, marginTop: 4 },
  card: { backgroundColor: C.cardBg, borderRadius: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 6, elevation: 2, marginHorizontal: 16, marginTop: 8, padding: 16 },
